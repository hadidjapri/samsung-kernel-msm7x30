...
MODULES_DIR=${HOME}/android/kernel/rootbox/ramdisk/lib/modules
RAMDISK_DIR=${HOME}/android/kernel/rootbox/ramdisk
KERNEL_DIR=`pwd`
OUTPUT_DIR=${HOME}/android/kernel/rootbox/build
ZIMAGE_DIR=${HOME}/android/arco-kernel/samsung-kernel-msm7x30/arch/arm/boot
ANYKERNEL_DIR=${HOME}/android/kernel/rootbox
